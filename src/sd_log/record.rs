...
pub const SD_RECORD_SIZE: usize = 161;
...
pub const SD_RECORD_FIELDS: &[PacketField] = &[
    ...
    PacketField { name: "BARO ALT",  offset: 69,  length: 4,  color: [100, 180, 255] },
    PacketField { name: "POS X",     offset: 73,  length: 4,  color: [255, 200, 100] },
    PacketField { name: "POS Y",     offset: 77,  length: 4,  color: [255, 210, 120] },
    PacketField { name: "POS Z",     offset: 81,  length: 4,  color: [255, 220, 140] },
    PacketField { name: "VEL X",     offset: 85,  length: 4,  color: [100, 255, 200] },
    PacketField { name: "VEL Y",     offset: 89,  length: 4,  color: [120, 255, 210] },
    PacketField { name: "VEL Z",     offset: 93,  length: 4,  color: [140, 255, 220] },
    PacketField { name: "QUAT W",    offset: 97,  length: 4,  color: [200, 200, 255] },
    PacketField { name: "QUAT X",    offset: 101, length: 4,  color: [210, 200, 255] },
    PacketField { name: "QUAT Y",    offset: 105, length: 4,  color: [220, 200, 255] },
    PacketField { name: "QUAT Z",    offset: 109, length: 4,  color: [230, 200, 255] },
    PacketField { name: "PDIAG",     offset: 113, length: 36, color: [180, 180, 180] },
    PacketField { name: "FLAGS",     offset: 149, length: 4,  color: [255, 80, 80] },
    PacketField { name: "BATTERY",   offset: 153, length: 4,  color: [255, 255, 0] },
    PacketField { name: "STATE",     offset: 157, length: 1,  color: [0, 200, 255] },
    PacketField { name: "RELAY",     offset: 158, length: 1,  color: [255, 165, 0] },
    PacketField { name: "CMD",       offset: 159, length: 1,  color: [180, 180, 255] },
    PacketField { name: "SYNC END",  offset: 160, length: 1,  color: [255, 255, 255] },
];
