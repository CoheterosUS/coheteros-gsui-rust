use crate::telemetry::packet::PacketField;
use super::theme;
...
fn field_color(offset: usize, fields: &[PacketField], dark_mode: bool) -> egui::Color32 {
    for field in fields {
...
fn byte_field<'a>(offset: usize, fields: &'a [PacketField]) -> &'a str {
    for field in fields {
        if offset >= field.offset && offset < field.offset + field.length {
            return field.name;
        }
...
pub fn hex_viewer(ui: &mut egui::Ui, raw: &[u8], fields: &[PacketField], dark_mode: bool) {
